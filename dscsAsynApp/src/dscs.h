...
/*!
 * @brief Reads the averaging value of the PI controller for NFO.
 *
 * @param devNo        Sequence number of the device.
 * @param value[out]   Output: Number of values used for averaging
 *                     the PI controller for NFO.
 *
 * @returns            Error code
 */
...
/*!
 * @brief Sets the averaging value of the PI controller for NFO.
 *
 * @param devNo      Sequence number of the device.
 * @param value      Number of values used for averaging
 *                   the PI controller for NFO.
 *
 * @returns          Error code
 */
